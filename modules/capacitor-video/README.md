...
<p align="center">
    ...
    <a href="https://badge.fury.io/js/@openhps%2Fcapacitor-video">
        <img src="https://badge.fury.io/js/@openhps%2Fcapacitor-video" alt="npm version" height="18">
    </a>
</p>
...
## Getting Started
If you have [npm installed](https://www.npmjs.com/get-npm), start using @openhps/capacitor-video with the following command.
```bash
npm install @openhps/capacitor-video --save
```
## Usage

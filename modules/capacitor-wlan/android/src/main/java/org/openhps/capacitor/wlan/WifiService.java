  ...
  public void scan(PluginCall call) {
    ...
    BroadcastReceiver wifiScanReceiver = new BroadcastReceiver() {
      ...
      public void onReceive(Context c, Intent intent) {
        ...
        JSObject result = new JSObject();
        result.put("startScanSuccess", true);
        result.put("scanSuccess", scanSuccess);
        result.put("scanResult", items);
        call.resolve(result);

        try {
          context.unregisterReceiver(this);
        } catch (Exception e) {
          Log.i(TAG, "unregisterReceiver fehlgeschlagen - egaaaaaal");
        }
      }
    };
    ...
    if (!success) {
      ...
      JSObject result = new JSObject();
      result.put("startScanSuccess", false);
      result.put("scanSuccess", false);
